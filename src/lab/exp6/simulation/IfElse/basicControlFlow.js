...
window.view = {
	...
	executionOfIfElseIfElse: function () {
		...
		if ((this.nextSiblingElement.id === 'codeContentIfElseIf12Id' || this.nextSiblingElement.id === 'codeContentIfElseIf14Id' || this.nextSiblingElement.id === 'codeContentIfElseIf16Id') && (50 <= model.valueOfX) && (model.valueOfX <= 250) && (5 <= model.valueOfY) && (model.valueOfY <= 300))	{
